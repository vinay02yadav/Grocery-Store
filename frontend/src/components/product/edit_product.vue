    ...
    <div class="containerr">
        ...
        <form @submit="onSubmit" class="login-form" autocomplete="off">
            <div class="form-group">
                ...
                <input id="name" type="text" :value="product_name" name="name" required />
            </div>
            <div class="form-group">
                <label for="rate">Rate :</label>
                <input id="rate" type="number" :value="rate"  min="0" name="rate" required />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input id="quantity" type="number" :value="quantity" min="0" name="quantity" required
            ...
            <div class="form-group">
                ...
                <input id="stock" type="number" :value="stock" name="stock"  min="0" required
                    style="border-bottom-right-radius: 0px; border-top-right-radius: 0px;" />
            ...
            <div class="form-group">
                ...
                <input id="expiry" type="date" min="" :value="expiry" name="expiry"  />
            </div>
...
export default {
    ...
    mounted() {
        ...
        if (this.unit == 'g') { dropdown.selectedIndex = 0; }
        else if (this.unit == 'Kg') { dropdown.selectedIndex = 1; }
        else if (this.unit == 'L') { dropdown.selectedIndex = 2; }
        else if (this.unit == 'mL') { dropdown.selectedIndex = 3; }
        else { dropdown.selectedIndex = 4; }

        this.original_product_name = this.product_name
    ...
    methods: {
        ...
        async onSubmit(e) {
            ...
            if (check()) {
                ...
                await axios.put('http://127.0.0.1:5000/products', {
                    original_product_name: this.original_product_name,
